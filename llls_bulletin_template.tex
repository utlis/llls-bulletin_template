...
\usepackage{llls}
% 追加したいパッケージやマクロは以下に記述してください

\begin{document}
% \English  % 全編英語にしたい場合はこの行をコメントアウトしてください
% またtitleやabstractのコマンド名を英語版のものに入れ替えてください

\twocolumn[
\voltitle{XX}{XXXX}

\begin{center}
  \jtitle{{\Large 論文/研究ノート/資料} \\『生涯学習基盤経営』における論文等の執筆マニュアル}{---\LaTeX{}
  バージョン（多言語サンプル：\foreignlanguage{korean}{한국어}、\foreignlanguage{schinese}{简体中文}、\foreignlanguage{tchinese}{繁體中文}）---}
\end{center}
...
\begin{center}
  \begin{abstract}
    ...
    ファイルをそのまま使用して論文を作成することを推奨します。（多言語サンプル：\foreignlanguage{korean}{한국어}、\foreignlanguage{schinese}{简体中文}、\foreignlanguage{tchinese}{繁體中文}）
